...
//				if(!overlaytex) overlaytex = textureload("data/guioverlay.png", 3);
				if(!overlaytex || overlaytex == notexture)
				{
					defformatstring(tname)("data/%s.png", guioverlaytex);
...
//			if(!slidertex) slidertex = textureload("data/guislider.png", 3);
            if(!slidertex || slidertex == notexture)
			{
				defformatstring(tname)("data/%s.png", guislidertex);
				slidertex = textureload(tname, 3);
			}
//////////////////////////////////////////////////////////////////////////////////////////
...
//		if(!skintex) skintex = textureload("data/guiskin.png", 3);
		...
		{
			defformatstring(tname)("data/%s.png", guiskintex);
...
///////////////////////////////////////////////////////////////////////////////////////////
SVARFP(guioverlaytex, "skin/default/guioverlay", defformatstring(tname)("data/%s.png", guioverlaytex); gui::overlaytex = textureload(tname, 3););
SVARFP(guiskintex, "skin/default/guiskin",       defformatstring(tname)("data/%s.png", guiskintex);    gui::skintex    = textureload(tname, 3););
SVARFP(guislidertex, "skin/default/guislider",   defformatstring(tname)("data/%s.png", guislidertex);  gui::slidertex  = textureload(tname, 3););
///////////////////////////////////////////////////////////////////////////////////////////
