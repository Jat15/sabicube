...
////////////////////////////////////////////////////////
        void suicide()
        {
			if(etype==BOX)
			{
				defformatstring(aliasname)("item_pickup_%i", (mapmodel));
				{
					execute(aliasname);
//					inventorywrite(mapmodel)(1);
				}
				state = CS_DEAD;
			}
			if(etype==XBOX) // keypads and npc's
			{
				defformatstring(aliasname)("item_activate_%i", (mapmodel));
				{
					execute(aliasname);
				}
			}
...
////////////////////////////////////////////////////////////
    ...
    void clearmovables()
    {
        ...
        loopv(entities::ents) 
        {
            ...
            if(e.type!=BOX && e.type!=XBOX && e.type!=BARREL && e.type!=PLATFORM && e.type!=ELEVATOR) continue;
